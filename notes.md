...
- Spines: 10.0.0.1/32, 10.0.0.2/32
- Leaves: 10.0.0.11/32, 10.0.0.12/32
- Spines in the low range, leaves in 10+

Point-to-point link addressing:

- Spine1 ↔ Leaf1: 10.1.1.0/30 (spine .1, leaf .2)
- Spine1 ↔ Leaf2: 10.1.2.0/30
- Spine2 ↔ Leaf1: 10.1.3.0/30
- Spine2 ↔ Leaf2: 10.1.4.0/30
- The third octet identifies the link. Spine always gets .1 on each link, leaf always gets .2
